...
extension = [Extension(name="machine_learning.decomposition", 
             ...
             Extension(name="machine_learning.data_structures", 
                       sources=["data_structures/priority_queue.pyx", "data_structures/KeyedPriorityQueue.cpp"], 
                       language='c++', 
                       include_dirs=[numpy.get_include()])]
...
setup(
    ...
    version="1.0",
    description=("A module containing Machine Learning algorithms used in the comparative FERET study project."),
    license="MIT",
